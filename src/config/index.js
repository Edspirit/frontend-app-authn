const configuration = {
  ...
  ENABLE_AUTO_GENERATED_USERNAME:
    process.env.ENABLE_AUTO_GENERATED_USERNAME || false,
  ENABLE_DYNAMIC_REGISTRATION_FIELDS:
    process.env.ENABLE_DYNAMIC_REGISTRATION_FIELDS || false,
  ENABLE_PROGRESSIVE_PROFILING_ON_AUTHN:
    process.env.ENABLE_PROGRESSIVE_PROFILING_ON_AUTHN || false,
  ...
  SHOW_CONFIGURABLE_EDX_FIELDS:
    process.env.SHOW_CONFIGURABLE_EDX_FIELDS || false,
  ...
  ACTIVATION_EMAIL_SUPPORT_LINK:
    process.env.ACTIVATION_EMAIL_SUPPORT_LINK || null,
  ...
  POST_REGISTRATION_REDIRECT_URL:
    process.env.POST_REGISTRATION_REDIRECT_URL || '',
